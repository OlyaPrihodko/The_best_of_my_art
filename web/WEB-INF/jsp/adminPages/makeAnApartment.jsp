...
<fmt:message bundle="${loc}" key="locale.message.Message26" var="Message26"/>
<fmt:message bundle="${loc}" key="locale.message.Message27" var="Message27"/>
<html lang="${language}">
<head>
    <title>${Message27}</title>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form role="form" action="controller" method="post" name="form"
                          onsubmit="if(document.getElementById('command').value=='make-an-apartment')return validate();">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-8  col-lg-offset-3" >
                                ...
                                <div class="btn-group">
                                    <button  type="submit" class="btn btn-labeled btn-primary"
                                             onclick="document.getElementById('command').value='make-an-apartment';
